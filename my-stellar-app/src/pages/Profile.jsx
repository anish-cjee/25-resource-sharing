...
import { checkConnection, listResource, borrowResource, returnResource, rateTransaction, getResource, listResources, getAvailableCount } from "../lib/stellar.js";
import "../App.css";
import "./Profile.css";
...
export default function Profile({ walletKey, onDisconnect }) {
    ...
    const [walletState, setWalletState] = useState(walletKey);
    ...
    const onRefreshConnection = () => runAction("connect", async () => {
            ...
            <nav className="profile-nav">
                <div className="profile-nav-inner">
                    <div className="profile-nav-brand">
                        ...
                        <span className="profile-nav-title">Resource Sharing</span>
                    </div>
                    <div className="profile-nav-right">
                        ...
                        <button
                            type="button"
                            className={`profile-action-btn refresh ${loadingAction === "connect" ? "btn-loading" : ""}`}
                        ...
                        {onDisconnect && (
                            <button
                                type="button"
                                className="profile-action-btn disconnect"
